...
namespace ft
{
	...
	public:
		...
		typedef ft::map_iter<Key, T, Compare>			iterator;
		typedef ft::map_const_iter<Key, T, Compare>		const_iterator;
		typedef ft::map_rev_iter<Key, T, Compare>		reverse_iterator;
		typedef ft::map_rev_const_iter<Key, T, Compare>	const_reverse_iterator;
